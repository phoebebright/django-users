# Generated by Django 5.1.2 on 2025-11-16 20:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_type', models.CharField(blank=True, max_length=20, null=True)),
                ('registration_code', models.CharField(blank=True, max_length=20, null=True)),
                ('creator', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_creator', to=settings.AUTH_USER_MODEL)),
            ...
            options={
                'abstract': False,
                'indexes': [models.Index(fields=['user', 'active', 'role_type'], name='users_role_user_id_e33e41_idx'), models.Index(fields=['user', 'organisation', 'role_type'], name='users_role_user_id_516c21_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(condition=models.Q(('consumed_at__isnull', True), ('expires_at__gt', datetime.datetime(2025, 11, 16, 20, 32, 59, 69784, tzinfo=datetime.timezone.utc))), fields=('user', 'channel', 'purpose'), name='uniq_active_user_channel_purpose')],
            },
        ),
    ]
