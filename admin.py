...
from .models import Organisation, UserContact, CustomUser as User, CustomUser
...
def add_user(client, user):
    ...
    :param django_keycloak_admin.models.Client client:
...
add_to_keycloak.short_description = "Add to Keycload"
...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ('email', 'person','username','is_active','last_login','date_joined', 'subscribed', 'unsubscribed')
    list_filter = ('is_staff', 'is_active', 'status','subscribed', 'unsubscribed')
...
class OrgansiationAdminForm(forms.ModelForm):
    class Meta:
        model = Organisation
        fields = '__all__'
...
class OrgansiationAdmin(admin.ModelAdmin):
    form = OrgansiationAdminForm
    readonly_fields = ('decrypt_secret_data',)
